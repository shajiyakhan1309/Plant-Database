...
def enter_data():
    ...
    if not plant_name or not plant_id or not plant_color or not fruit_color or not fruit_season or not benefits:
    ...
    cursor.execute('''
        INSERT INTO plant_info (plant_name, plant_id, plant_color, fruit_color, fruit_season, benefits)
        VALUES (?, ?, ?, ?, ?, ?)
    ''', (plant_name, plant_id, plant_color, fruit_color, fruit_season, benefits))
